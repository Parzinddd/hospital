...
Page({
    ...
    data: {
        ...
        productService:'产品服务',
        service:'辅助临床项目试验进展服务、科学研究支持服务、健康咨询、就医指引、药物咨询、营养咨询、医保咨询',
        businessPhilosophy:'经营理念',
        concept1:'医疗服务的进步，离不开科研领域探索，我们与监管机关和科研中心合作，进行肿瘤药物、医疗器械、前卫的细胞治疗方案的研发，同时协助建立符合中国细胞产业发展且适用于医院的操作及质量规范，从评估细胞供体的筛选、细胞供体的采集及运输皆有专业安全的设备和规范化的采集流程。',
        concept2:'我司主要的服务项目，包含招募对医学临床试验感兴趣，且愿意提供协助的志愿者；临床试验通常是由生技药厂或医师发起，为了研究新的治疗方式、药品、医疗器材、疫苗在人体运用的安全性与有效性。',
    ...
    translateToEng:function(e){
        this.setData({
            ...
            service:'Auxiliary clinical project trial progress service, scientific research support service, health consultation, medical guidance, drug consultation, nutrition consultation, medical insurance consultation',
